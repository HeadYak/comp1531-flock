...
def test_channels_list():
    ...
    assert channels_list(token1) == [{'channel_id': ch_id1, 'name': "aGreatChannel", 'is_public': True, 'creator': token1, 'owners': [u_id1], 'members': [u_id1], 'messages': []},
                                     {'channel_id': ch_id3, 'name': "SameName", 'is_public': True, 'creator': token1, 'owners': [u_id1], 'members': [u_id1], 'messages': []}]
                                                               
    assert channels_list(token2) == [{'channel_id': ch_id2, 'name': "yetAnotherChannel", 'is_public': False, 'creator': token2, 'owners': [u_id2], 'members': [u_id2], 'messages': []},
    ...
    assert channels_list(token2) == [{'channel_id': ch_id2, 'name': "yetAnotherChannel", 'is_public': False, 'creator': token2, 'owners': [], 'members': [u_id1], 'messages': []}]
