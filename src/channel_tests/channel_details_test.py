...
def test_channel_details():
    ...
    '''
    clear()
    token = auth_register('validemail@gmail.com', '123abc!@#', 'Hayden', 'Everest', None)['token']
...
def test_channel_details_not_member():
    ...
    token = auth_register('validemail@gmail.com', '123abc!@#', 'Hayden', 'Everest', None)['token']
    channel_id = channels_create(token, 'TestChannel', True)['channel_id']
    token1 = auth_register('anothervalidemail@gmail.com', '123abc!@#', 'Hayden', 'Everest', None)['token']
